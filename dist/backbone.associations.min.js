 ...
 */
(function(){"use strict";Backbone.Associations={};var e=Backbone.Associations.BelongsTo={};_.extend(Backbone.Associations.BelongsTo=function(e){},e,{prototype:_.extend(e.prototype,{})});var t=Backbone.Associations.HasMany={};_.extend(Backbone.Associations.HasMany=function(e){},t,{prototype:_.extend(t.prototype,{})});var n=Backbone.Associations.HasOne={};_.extend(Backbone.Associations.HasOne=function(e){},n,{prototype:_.extend(n.prototype,{})});var r=Backbone.Model;_.extend(Backbone.Model=function(){r.apply(this,arguments)},r,{prototype:_.extend(r.prototype,{belongsTo:{},hasMany:{},hasOne:{},toJSON:_.wrap(r.prototype.toJSON,function(e,t){t=_.extend({associations:!1},t);var n=e.call(this,t);return n})})}),Backbone.sync=_.wrap(Backbone.sync,function(e,t,n,r){if(t!=="read")return e.call(this,t,n,r);r=_.extend({},r);var i=$.Deferred(),s=[],o=_.bind(function(e,t,n){delete this._xhrCache,_.isFunction(e)&&e.call(this,this,t,n)},n),u=_.bind(function(e,t,n,s){i.resolve(t,n,s),_.isFunction(e)&&e.call(this,this,t,r)},n),a=_.bind(function(e,t,n,s){i.reject(t,n,s),_.isFunction(e)&&e.call(this,this,t,r)},n),f=_.bind(function(){_.isUndefined(this._xhrCache)?this._xhrCache=e.call(this,"read",n,r):this._xhrCache.then(i.resolve,i.reject)},n);return _.extend(r,{complete:_.wrap(r.complete,o),success:_.wrap(r.success,u),error:_.wrap(r.error,a)}),$.when.apply($,s).then(f),i.promise()})})();